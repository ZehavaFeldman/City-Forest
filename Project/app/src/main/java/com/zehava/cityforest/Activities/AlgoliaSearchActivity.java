...
//        index.searchAsync(loadMoreQuery, new CompletionHandler() {
            ...
            if(cell != null) {
                cell.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent i = new Intent(AlgoliaSearchActivity.this, SelectedTrackDetailsActivity.class);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.dog:
                search(getString(R.string.dog));
                break;

            case R.id.water:
                search(getString(R.string.water));
                break;
            case R.id.cutlery:
                filter="type:\"בית קפה\"";
                filter();
                break;
            case R.id.bicycle:
                search(getString(R.string.bike));
                break;
            case R.id.history:
