...
public class CreateUserUpdateActivity extends AppCompatActivity {
    ...
    private void writeNewUserUpdate() {
        ...
        * the coordinate ready to be entered to the JSON tree*/
        ...
        user_updates.child(PMethods.getInstance().getMarkerHashKey(chosenCoordinateLatLng.getLongitude())).updateChildren(childUpdates, new DatabaseReference.CompletionListener() {
            @Override
