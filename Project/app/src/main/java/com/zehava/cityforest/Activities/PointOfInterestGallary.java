     ...
     //   loading_progress_bar.setVisibility(View.INVISIBLE);
        ...
        images.child(directoryName).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                RecyclerView.LayoutManager layoutManager = new GridLayoutManager(PointOfInterestGallary.this, 2);
                RecyclerView recyclerView = (RecyclerView) findViewById(R.id.rv_images);
                recyclerView.setHasFixedSize(true);
                recyclerView.setLayoutManager(layoutManager);

                PointOfInterestGallary.ImageGalleryAdapter adapter = new PointOfInterestGallary.ImageGalleryAdapter(PointOfInterestGallary.this, imagesPaths);
